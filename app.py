...
escopos_iveco = {
    "001": {
        "tarefas": ["LU0389 Substituir oleo do motor", "LU0329 Substituir filtro de oleo do motor", "LU0319 Substituir filtro de ar primario", "LU0321 Substituir filtro de ar secundario", "LU0322 Substituir filtro de combustivel", "LU0348 Substituir filtro separador de agua", "LU0153 Lubrificacao Geral", "LU0159 Lubrificar arvore de transmissao", "LU0290 Lubrificar terceiro eixo auxiliar(cubos rodas)", "ME0147 Inspecionar e controlar indicador obstrucao filtro ar", "ME0095 Inspecionar as lonas de freios", "ME0375 Inspecionar tandem traseiro", "ME0493 Sanar vazamentos de todos grupos mecanicos", "ME0071 Inspecionar ajuste porcas grampos feixe molas", "ME0070 Inspecionar abracadeiras vedacao condicao mancheiras aspiracao", "ME0412 Inspecionar vedacao da junta da tampa do filtro de ar", "ME0368 Inspecionar sistema de arrefecimento e aquecedor", "ME0369 Inspecionar sistema de basculamento da cabine", "ME0215 Inspecionar funcionamento dispositivo bloqueio sinalizador"],
        "materiais": {"Código": ["02684", "24068", "24071", "24072", "24067", "24069", "24070", "16659"], "Descrição": ["ÓLEO MINERAL SAE 15W/40 API CI-4 (VOLV", "FILTRO ÓLEO IVECO NEXPRO (500058314)", "FILTRO AR PRIMÁRIO IVECO NEXPRO (50005", "ELEMENTO FILTRANTE AR SECUNDÁRIO IVECO", "FILTRO COMBUSTÍVEL IVECO NEXPRO (50005", "FILTRO COMBUSTÍVEL IVECO NEXPRO (50005", "FILTRO SEPARADOR ÁGUA/COMBUSTÍVEL IVEC", "GRAXA MINERAL SABÃO DE LÍTIO NLGI 3 PE"], "Qtd": ["11,60 L", "1,00 PC", "1,00 PC", "1,00 PC", "1,00 PC", "1,00 PC", "1,00 PC", "1,50 KG"]}
    },
    "002": {
        ...
        "materiais": {"Código": ["MAO-MEC"], "Descrição": ["MECANICO-FROTA (MÃO DE OBRA MPREV)"], "Qtd": ["1,00 H"]}
    },
    "003": {
        "tarefas": ["ME0506 Substituir correia dos comandos auxiliares do motor principal", "ME0191 Inspecionar fixacao da suspensão do motor", "ME0225 Inspecionar interferencias das partes moveis", "LU0303 Substituir oleo do cambio e limpeza do respiro de vapores", "LU0384 Substituir oleo do diferencial", "LU0132 Limpar o respiro dos vapores de oleo", "LU0396 Substituir oleo dos cubos das rodas dianteiras"],
        "materiais": {"Código": ["08892", "02697", "07105"], "Descrição": ["CORREIA POLY V IVECO (4898546)", "ÓLEO MINERAL SAE 40 API CF ACEA E2.", "ÓLEO MINERAL SAE 85W/140 API GL-5"], "Qtd": ["1,00 PC", "15,00 L", "22,70 L"]}
    },
...
with aba1:
    ...
    seq_sel = st.selectbox("Selecione uma sequência ativa:", listagem_menu_dinamico)
